...
class ParticleFilter:
    ...
    def get_octomap(self, map_msg):
        ...
        self.occupancy_field = LikelihoodField(map_msg)
    ...
    def lidar_received(self, lidar_msg):
        ...
        p = PoseStamped(header=Header(frame_id=lidar_msg.header.frame_id))
    ...
    def update_particles_with_lidar(self, msg):
        ...
        for particle in self.particle_cloud:
            ...
            for index, scan in enumerate(xyz_cloud):
                ...
                #x = self.current_odom_xy_theta[0] + distance * math.cos(
                #    math.radians(self.current_odom_xy_theta[2] + angle))
                #y = self.current_odom_xy_theta[1] + distance * math.cos(
                #    math.radians(self.current_odom_xy_theta[2] + angle))
